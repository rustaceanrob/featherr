  ...
  return (
    <div className='flex flex-col pl-20 lg:pl-60 lg:pr-60 md:pl-40 md:pr-40 pr-20 pt-10 pb-10'>
        <div className='grid grid-cols-1 xl:grid-cols-3 md:grid-cols-2 gap-6 pb-5'>
            ...
            <Tile feature={"Math"} setFeature={setFeature} icon={<TbMathSymbols size={20} className='text-amber-700'/>} message={"Solve math problems"}/>
            ...
            <Tile feature={"Write"} setFeature={setFeature} icon={<TfiWrite className='text-amber-700'/>} message={"Overcome writer's block"}/>
        </div>
    </div>
  )
}
