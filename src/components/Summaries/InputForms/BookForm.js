...
export default function BookForm({summary, credits, setUserCredits, setSummary, setSummaryLoading}) {
    ...
    const [toggleAdvanced, setToggleAdvanced] = useState(true)
                    ...
                    toggleAdvanced ? (
                        <>
                            <div className='pt-5 pb-5'>
                                <div className='flex flex-row border grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2 justify-center items-center rounded-lg px-5 py-5'>
