        ...
        <div>
            <form className="border rounded-lg px-5 py-5 grid grid-cols-1  gap-2 justify-center items-center" onSubmit={getTLDRFromGPT}>
                <div className='flex flex-col justify-center items-start'>
                    ...
                    <textarea rows="10" className="w-full font-normal block px-2 py-2 border-slate-100 rounded-md shadow-sm focus:outline-none" maxlength="15000" value={prompt} placeholder="What text would you like summarized? Up to 15,000 characters." onChange={handlePromptChange}/>
                </div>
