            ...
            </button>
            {
                toggleDrop ? (
                    <div className='absolute top-15 bg-white border rounded-md px-5 py-5 flex flex-col justify-start items-start'>
                        ...
                        <button className='font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-700 hover:scale-110 duration-200 pt-2' onClick={() => onNavigationClick("Math")}>Math</button>
                        ...
                        <button className='font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-700 hover:scale-110 duration-200 pt-2' onClick={() => onNavigationClick("Write")}>Write</button>
