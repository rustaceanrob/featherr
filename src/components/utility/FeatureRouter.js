...
export default function FeatureRouter({currentFeature, setFeature}) {
    ...
    return (
        <div className="absolute top-4 sm:top-5 sm:left-10 left-3 block flex flex-row">
            ...
            </button>
            {
                toggleDrop ? (
                    <div className='absolute top-15 bg-white border rounded-md px-5 py-5 flex flex-col justify-start items-start'>
                        <button className='font-extrabold text-blue-600 hover:scale-110 duration-200' onClick={() => onNavigationClick("Cite")}>Cite</button>
                        ...
                        <button className='font-extrabold text-blue-600 hover:scale-110 duration-200 pt-2 pb-2 border-b' onClick={() => onNavigationClick("Summarize")}>Summarize</button>
